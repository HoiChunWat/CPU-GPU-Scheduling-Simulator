...
scheduler_baseline.c
  ...
  FCFS      SJF     Priority    Round Robin
   ...
   +---------+---------+-------------+
        |
        v
Waiting / Turnaround / Response Time Analysis


Phase 2 — Parallel CPU Benchmark
--------------------------------
Random Task Generator
        |
        v
...
pthread Worker Pool
  ...
  FCFS      SJF     Priority    Round Robin
   ...
   +---------+---------+-------------+
        |
        v
1 / 2 / 4 / 8 / 16 / 20 / 24 / 32 Threads
        |
        v
Runtime / Speedup / Parallel Efficiency


Phase 3 — Planned Extension
---------------------------
CPU Task Execution + CUDA GPU Execution
        |
        v
